...
import { YouTubeIcon } from "@/components/public/shared/youtube-icon";
...
const communityLinks = [
  {
    ...
    description:
      "Watch Italian lessons, learning guidance, webinar content and useful video resources.",
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {values.map(({ title, description, icon: Icon }) => (
              ...
              >
                ...
                <p className="mt-3 leading-7 text-[#627067]">{description}</p>
              </article>
            ))}
          </div>
        </div>
