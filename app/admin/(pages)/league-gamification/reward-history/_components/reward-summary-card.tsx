...
import type { LeaderboardRewardSummary } from "@/types/leaderboard/leaderboard.type";

interface RewardSummaryCardProps {
  summary: LeaderboardRewardSummary | null;
}

export default function RewardSummaryCard({ summary }: RewardSummaryCardProps) {
  return (
        ...
        <div>
          ...
          <div className="flex items-end gap-2">
            <h2 className="text-2xl font-bold leading-none text-secondary">
              {(summary?.totalRewardsGiven || 0).toLocaleString()}
            </h2>
